...
- **CLI args**: backtest `argparse` provides `--start/--end/--symbols/--run_id`. Evidence: `bot/backtest.py:L1052-L1108`. Parameter sweep `argparse` provides `--params/--start/--end/--symbols/--overwrite/--workers`. Evidence: `bot/param_sweep.py:L290-L330`.
